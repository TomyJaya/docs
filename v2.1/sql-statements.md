...
[`SHOW ZONE CONFIGURATIONS`](show-zone-configuration.html) | <span class="version-tag">New in v2.1:</span> List details about existing [replication zones](configure-replication-zones).
